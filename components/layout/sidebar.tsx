  ...
  return (
    <Link
      ...
      className={cn(
        ...
        active ? "border border-primary-light/15 bg-primary/[.22] text-white shadow-[inset_3px_0_0_#AABCE1]" : "border border-transparent text-zinc-500 hover:bg-white/[.035] hover:text-zinc-200",
      )}
    >
